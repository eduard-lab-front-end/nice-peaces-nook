...
const Modal = ({title, description, btnTitle, path, classes}) => {
  return (
    <div className={`md:absolute max-w-sm bg-white/50 backdrop-filter backdrop-blur-[15px] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ${classes}`}>
      <a href="#">
